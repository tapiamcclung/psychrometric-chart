 ...
 *-------------------------------------------------------------------------*/
import {csvParseRows} from "https://cdn.jsdelivr.net/npm/d3@7/+esm";
export const epwJson = raw => {
    //read raw file
    var epw_raw = csvParseRows(raw);
    ...
    epw.getDataByField = function(fieldNumber) {
      data = [];
      //fila 5 'uncertainty' está en formato alfanumerico
      if (fieldNumber == 5) {
